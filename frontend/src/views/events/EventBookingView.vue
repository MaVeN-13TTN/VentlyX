  ...
  <div class="min-h-screen bg-background-light dark:bg-background-dark">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <!-- Session Timer -->
        <div v-if="sessionActive" class="mt-4 p-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg">
...
const startSessionTimer = () => {
  ...
  sessionTimerId.value = setInterval(() => {
    if (sessionTimeRemaining.value > 0) {
      ...
      clearSessionTimer();
      notificationStore.warning('Your ticket reservation has expired. Please try again.');
