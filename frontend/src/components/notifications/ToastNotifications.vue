...
<template>
  ...
  >
    <div
      ...
      :key="notification.id"
      class="flex items-center min-w-[300px] p-4 rounded-lg shadow-lg"
      :class="{
    ...
    >
      ...
      <button
        ...
        class="flex-shrink-0 ml-3 p-1 rounded-full hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-offset-2"
        :class="{
