<template>
  <header
    class="bg-white/80 dark:bg-background-dark/80 shadow-sm backdrop-blur-md fixed top-0 left-0 right-0 z-50 border-b border-gray-100 dark:border-gray-800"
  >
    <div class="container mx-auto px-6">
      <div class="flex items-center justify-between h-16">
        ...
        <router-link to="/" class="flex items-center space-x-3 group">
          <div
            class="w-10 h-10 bg-gradient-to-br from-primary to-secondary rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105"
          >
          ...
          <div v-else class="relative">
            ...
            >
              <div
                ...
                class="w-9 h-9 rounded-full overflow-hidden shadow-sm ring-2 ring-white dark:ring-gray-800"
              >
                <img
              ...
              <div
                v-else
                class="w-9 h-9 bg-gradient-to-br from-primary to-accent-pink rounded-full flex items-center justify-center text-white shadow-sm ring-2 ring-white dark:ring-gray-800"
              >
                {{ currentUser?.name?.charAt(0).toUpperCase() || "U" }}
              </div>
              <span
                class="hidden md:block text-text-light dark:text-text-dark font-medium"
            ...
            >
              <div
                class="px-4 py-2 border-b border-gray-100 dark:border-gray-800 mb-2"
              >
                <p
                ...
                <p
                  class="text-xs text-text-light/60 dark:text-text-dark/60 truncate"
                >
                  {{ currentUser?.email }}
                </p>
              </div>
              ...
              <!-- Organizer Links -->
              <template v-if="isOrganizer || isAdmin">
                <div
      ...
      >
        <router-link
          ...
          :class="
            $route.path === '/'
              ...
              : 'text-text-light/80 dark:text-text-dark/80 hover:bg-gray-100 dark:hover:bg-gray-800'
          "
        ...
        <template v-if="isAuthenticated">
          ...
          <template v-if="isOrganizer || isAdmin">
            ...
            <router-link
              to="/organizer/events"
              class="block py-3 px-4 pl-8 rounded-lg font-medium transition-all duration-200"
              :class="
                $route.path.includes('/organizer/events')
                  ? 'bg-primary/10 text-primary dark:bg-dark-primary/10 dark:text-dark-primary'
                  : 'text-text-light/80 dark:text-text-dark/80 hover:bg-gray-100 dark:hover:bg-gray-800'
              "
              @click="closeMobileMenu"
            ...
            <router-link
              ...
              class="block py-3 px-4 pl-8 rounded-lg font-medium transition-all duration-200"
              :class="
                $route.path.includes('/organizer/attendees')
                  ? 'bg-primary/10 text-primary dark:bg-dark-primary/10 dark:text-dark-primary'
                  : 'text-text-light/80 dark:text-text-dark/80 hover:bg-gray-100 dark:hover:bg-gray-800'
              "
              @click="closeMobileMenu"
            ...
            <router-link
              ...
              class="block py-3 px-4 pl-8 rounded-lg font-medium transition-all duration-200"
              :class="
                $route.path.includes('/organizer/analytics')
                  ? 'bg-primary/10 text-primary dark:bg-dark-primary/10 dark:text-dark-primary'
                  : 'text-text-light/80 dark:text-text-dark/80 hover:bg-gray-100 dark:hover:bg-gray-800'
              "
              @click="closeMobileMenu"
